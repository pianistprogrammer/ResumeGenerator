 ...
 * @example
 ...
 adminApp.controller('MyCtrl', function($scope) {
                    $scope.users = [
                        {name: "Moroni", age: 50},
                        {name: "Tiancum", age: 43},
                        {name: "Jacob", age: 27},
 ...
 */
adminApp.value('ngTableDefaults', {
    params: {},
    settings: {}
});
...
adminApp.factory('NgTableParams', ['$q', '$log', 'ngTableDefaults', function($q, $log, ngTableDefaults) {
 ...
 */
adminApp.factory('ngTableParams', ['NgTableParams', function(NgTableParams) {
    return NgTableParams;
}]);
/**
 * ngTable: Table + Angular JS
 ...
 */
adminApp.controller('ngTableController', ['$scope', 'NgTableParams', '$timeout', '$parse', '$compile', '$attrs', '$element',
    'ngTableColumn',
 ...
 */
adminApp.factory('ngTableColumn', [function () {
 ...
 */
adminApp.directive('ngTable', ['$q', '$parse',
    function($q, $parse) {
        'use strict';
 ...
 */
adminApp.directive('ngTableDynamic', ['$parse', function ($parse){
 ...
 * @restrict A
 */
adminApp.directive('ngTablePagination', ['$compile',
    function($compile) {
        'use strict';
