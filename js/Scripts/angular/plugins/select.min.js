    ...
    void 0 === angular.element.prototype.querySelectorAll && (angular.element.prototype.querySelectorAll = function (e) {
        ...
        return function () {
            ...
            c.parse = function (c) {
                ...
                if (!l)
                    throw e("iexp", "Expected expression in form of '_item_ in _collection_[ track by _id_]' but got '{0}'.", c);
            ...
            function r(t) {
                ...
                var l = o(h[0]), s = p.selected.length, i = 0, n = s - 1, a = p.activeMatchIndex, r = p.activeMatchIndex + 1, u = p.activeMatchIndex - 1, d = a;
            ...
            function u() {
                ...
                if (t.length < 1)
                    throw i("choices", "Expected multiple .ui-select-choices-row but got '{0}'.", t.length);
                var l = t[p.activeIndex], s = l.offsetTop + l.clientHeight - e[0].scrollTop, n = e[0].offsetHeight;
            ...
            if (1 !== h.length)
                throw i("searchInput", "Expected 1 input.ui-select-search but got '{0}'.", h.length);
            p.activate = function (e, t) {
                ...
                function l(e) {
                    p.groups = [], angular.forEach(e, function (e) {
                        var l = t.$eval(c), s = angular.isFunction(l) ? l(e) : e[l], i = p.findGroupByName(s);
                        i ? i.items.push(e) : p.groups.push({ name: s, items: [e] });
            ...
            p.refresh = function (e) {
                ...
                if (p.open) {
                    var t, c = p.items.indexOf(e[p.itemProperty]), l = !1;
                ...
                if (void 0 === e || !e._uiSelectChoiceDisabled) {
                    var l = {};
                    l[p.parserResult.itemName] = e, p.onSelectCallback(t, { $item: e, $model: p.parserResult.modelMapper(t, l) }), p.multiple ? (p.selected.push(e), p.sizeSearchInput()) : p.selected = e, p.close(c);
                }
            }, p.close = function (e) {
                ...
                var c = p.selected[e], l = {};
                l[p.parserResult.itemName] = c, p.selected.splice(e, 1), p.activeMatchIndex = -1, p.sizeSearchInput(), p.onRemoveCallback(t, { $item: c, $model: p.parserResult.modelMapper(t, l) });
            }, p.getPlaceholder = function () {
                return p.multiple && p.selected.length ? void 0 : p.placeholder;
            };
            var f;
            p.sizeSearchInput = function () {
                var e = h[0], c = h.parent().parent()[0];
                h.css("width", "10px");
                var s = function () {
            ...
            return { restrict: "EA", templateUrl: function (e, t) {
                    ...
                    var p = r[0], d = r[1], h = n.querySelectorAll("input.ui-select-search");
                    p.multiple = angular.isDefined(a.multiple) ? "" === a.multiple ? !0 : "true" === a.multiple.toLowerCase() : !1, p.onSelectCallback = i(a.onSelect), p.onRemoveCallback = i(a.onRemove), d.$parsers.unshift(function (e) {
                        var t, l = {};
                        if (p.multiple) {
                            for (var s = [], i = p.selected.length - 1; i >= 0; i--)
                                l = {}, l[p.parserResult.itemName] = p.selected[i], t = p.parserResult.modelMapper(c, l), s.unshift(t);
                            return s;
                        }
                        return l = {}, l[p.parserResult.itemName] = e, t = p.parserResult.modelMapper(c, l);
                    }), d.$formatters.unshift(function (e) {
                        var t, l = p.parserResult.source(c, { $select: { search: "" } }), s = {};
                        if (l) {
                            if (p.multiple) {
                                var i = [], n = function (e, l) {
                                    if (e && e.length) {
                                        for (var n = e.length - 1; n >= 0; n--)
                                            if (s[p.parserResult.itemName] = e[n], t = p.parserResult.modelMapper(c, s), t == l)
                    ...
                    a.tabindex && a.$observe("tabindex", function (e) {
                        ...
                        if (p.multiple && !angular.isArray(d.$viewValue)) {
                            if (!angular.isUndefined(d.$viewValue) && null !== d.$viewValue)
                                throw l("multiarr", "Expected model value to be array but got '{0}'", d.$viewValue);
                            p.selected = [];
                        }
                        ...
                        if (c.removeAttr("ui-select-match"), 1 !== c.length)
                            throw l("transcluded", "Expected 1 .ui-select-match but got '{0}'.", c.length);
                        n.querySelectorAll(".ui-select-match").replaceWith(c);
                        var s = t.querySelectorAll(".ui-select-choices");
                        if (s.removeAttr("ui-select-choices"), 1 !== s.length)
                            throw l("transcluded", "Expected 1 .ui-select-choices but got '{0}'.", s.length);
            ...
            return { restrict: "EA", require: "^uiSelect", replace: !0, transclude: !0, templateUrl: function (t) {
                    ...
                    if (!i.repeat)
                        throw c("repeat", "Expected 'repeat' expression.");
                    return function (s, i, n, a, r) {
                        ...
                        if (a.parseRepeatAttr(n.repeat, o), a.disableChoiceExpression = n.uiDisableChoice, o) {
                            ...
                            if (1 !== u.length)
                                throw c("rows", "Expected 1 .ui-select-choices-group but got '{0}'.", u.length);
                            u.attr("ng-repeat", t.getGroupNgRepeatExpression());
                        }
                        var p = i.querySelectorAll(".ui-select-choices-row");
                        if (1 !== p.length)
                            throw c("rows", "Expected 1 .ui-select-choices-row but got '{0}'.", p.length);
                        ...
                        if (1 !== d.length)
                            throw c("rows", "Expected 1 .ui-select-choices-row-inner but got '{0}'.", d.length);
